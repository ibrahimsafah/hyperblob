import { createSlider, createButton, createInfoDisplay, createFileDropZone, createSectionHeader, } from '../controls';
export function createDataTab(onLoadFile, onGenerate) {
    ...
    const dropZone = createFileDropZone({
        ...
        onFile: async (file) => {
            try {
                ...
                const hifLoader = await import(/* @vite-ignore */ hifPath);
                const parseHIF = hifLoader.parseHIF;
