...
export class ForceSimulation {
    ...
    mortonParams = new ArrayBuffer(32);
    mortonParamsF32 = new Float32Array(this.mortonParams);
    mortonParamsU32 = new Uint32Array(this.mortonParams);
    repulsionParams = new ArrayBuffer(48);
    repulsionParamsF32 = new Float32Array(this.repulsionParams);
    repulsionParamsU32 = new Uint32Array(this.repulsionParams);
    attractionParams = new ArrayBuffer(32);
    attractionParamsF32 = new Float32Array(this.attractionParams);
    attractionParamsU32 = new Uint32Array(this.attractionParams);
    centerParams = new ArrayBuffer(16);
    centerParamsF32 = new Float32Array(this.centerParams);
    centerParamsU32 = new Uint32Array(this.centerParams);
    integrateParams = new ArrayBuffer(16);
    integrateParamsF32 = new Float32Array(this.integrateParams);
    integrateParamsU32 = new Uint32Array(this.integrateParams);
    // Profiler (optional)
    profiler = null;
    // Bounding box tracking (updated from CPU periodically)
    bounds = { minX: -500, minY: -500, maxX: 500, maxY: 500 };
    boundsFrameCounter = 0;
    boundsUpdateInterval = 5; // update bounds every N frames
    constructor(device, bufferManager, data, _params, profiler, features = new Set()) {
        this.device = device;
    ...
    allocateBuffers() {
        ...
        this.bufferManager.createBuffer('morton-params', 32, GPUBufferUsage.UNIFORM | GPUBufferUsage.COPY_DST, 'morton-params');
        ...
        this.bufferManager.createBuffer('attraction-params', 32, GPUBufferUsage.UNIFORM | GPUBufferUsage.COPY_DST, 'attraction-params');
        // Repulsion params uniform (SimParams struct = 12 floats = 48 bytes, pad to 48)
        this.bufferManager.createBuffer('repulsion-params', 48, GPUBufferUsage.UNIFORM | GPUBufferUsage.COPY_DST, 'repulsion-params');
        // Center force buffers
        this.bufferManager.createBuffer('center-sum', 8, GPUBufferUsage.STORAGE | GPUBufferUsage.COPY_DST, 'center-sum');
        this.bufferManager.createBuffer('center-params', 16, GPUBufferUsage.UNIFORM | GPUBufferUsage.COPY_DST, 'center-params');
        // Integration params uniform
        this.bufferManager.createBuffer('integrate-params', 16, GPUBufferUsage.UNIFORM | GPUBufferUsage.COPY_DST, 'integrate-params');
    }
    rebuildBindGroups() {
